                    ...
                    <div className="">
                        ...
                        <div className="flex items-center gap-5 mt-12">
                            <div className="flex items-center">
                                <div className=''>
                                    <Image className="w-16 aspect-square bg-amber-100 rounded-full object-contain border-1 border-primary" src={AboutCustomer} alt="cus1" />
                                </div>
                                <div className="">
                                    <Image className="w-16 aspect-square bg-amber-100 rounded-full object-contain border-1 border-primary" src={AboutCustomer} alt="cus2" />
                                </div>
                                <div className="">
                                    <Image className="w-16 aspect-square bg-amber-100 rounded-full object-contain border-1 border-primary" src={AboutCustomer} alt="cus3" />
                                </div>
                            </div>
                            <div className="">

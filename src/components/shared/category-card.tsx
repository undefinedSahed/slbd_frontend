        ...
        <div>
            <Link href={`/shop?category=${title}`}>
                <div className="card border-1 border-green-600 rounded-t-md group-hover:shadow-primary group-hover:shadow-3xl group">
                    ...
                    <div className='text-center px-3 py-5 group-hover:bg-green-400 text-[#1B6732] group-hover:text-white border-green-400 rounded-b-md transition-all ease-in-out delay-100' >

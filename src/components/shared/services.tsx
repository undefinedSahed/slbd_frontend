      ...
      <div className="container lg:space-y-10 space-y-5">
        <div className="text-center max-w-5xl mx-auto space-y-5">
          <h2 className="lg:text-4xl text-xl font-bold">
            Lighting Up Modern Workspaces with Smarter Energy
          </h2>
          <p className="lg:text-lg text-sm text-justify lg:text-center text-gray-500">
            Workplaces are becoming more agile and innovative than ever. From
            personalized user control and real-time space insights to smart
            wayfinding, hot desking, and efficient meeting room bookings — we
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-10 items-center">
          {services.map((service) => (
            <div
              key={service.id}
              className="bg-[#e5e7eb] lg:space-y-8 space-y-4 lg:pb-8 pb-4"
            >
              <Image

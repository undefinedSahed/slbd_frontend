import { Facebook, MailIcon, MailsIcon, PhoneCallIcon } from "lucide-react";
      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-[2fr_1fr_1fr_1fr] md:grid-cols-3 gap-5 pb-5 border-b-2 border-primary">
          ...
          <div className="">
            <ul className="flex flex-col gap-2">
              <li className="text-primary font-semibold text-[16px] pb-2">
                Quick Links
              </li>
              <li className="text-[#727272] text-[16px]">
          ...
          <div className="">
            <ul className="flex flex-col gap-2">
              ...
              <li className="text-[#727272] text-[16px] flex gap-2 items-center">
                ...
                <a href="tel:+8801777210027">+880 1777-210027</a>
              </li>
              <li className="text-[#727272] text-[16px] flex items-center gap-2">
                <span>
                  <MailIcon />
                </span>
                <a href="mailto:superlightingbd@gmail.com">
                  superlightingbd@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="flex lg:flex-row flex-col gap-3 lg:gap-0 justify-between lg:items-center py-10 border-b-2 mb-2 border-primary">
          ...
          <p className="text-xs md:text-base">
            ...
            <Link
              href="https://mernsahed.netlify.app"
              target="_blank"
              className="font-bold text-primary underline px-1 md:px-2"
            >
              Md. Sahed Rahman
            </Link>
          </p>

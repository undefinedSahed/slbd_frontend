...
const HomeAbout = () => {
  const indoorLightingFeatures = [
    { id: 1, feature: "Wide Range of LED Products" },
    { id: 2, feature: "Expertise in Industrial Lighting" },
    { id: 3, feature: "Aordable, Energy-E cient Solutions" },
    { id: 4, feature: "Customized Lighting Project Support" },
    { id: 5, feature: "Consultation & After-Sales Service" },
  ];

  const outdoorLightingFeatures = [
    { id: 1, feature: "Manufacturing Plants" },
    { id: 2, feature: "Warehouses & Store" },
    { id: 3, feature: "Retail & Shopping Centers" },
    { id: 4, feature: "Offices & Commercial Space" },
    { id: 5, feature: "Educational Institutions" },
  ];
    ...
    <section className="py-8 lg:py-24 bg-gray-100">
      <div className="container mx-auto lg:px-0 px-4">
        <div className="grid lg:grid-cols-[4fr_3fr] gap-10">
          <div className="">
            <h2 className="text-primary text-2xl md:text-3xl underline underline-offset-5 font-semibold pb-10">
              About Us
            </h2>
                ...
                <div className="pt-3">
                  ...
                  <ul className="text-gray-700">
                    {indoorLightingFeatures.map((item) => (
                      <li
                        key={item.id}
                        className="text-[#A1A1A1] text-base font-medium mb-2 flex gap-4 items-center"
                      >
          ...
          <div className="bg-black rounded-lg p-10 flex justify-center items-center">
            <div className="grid grid-cols-3 grid-rows-3 w-full">
              ...
              <Image
                src={quality}
                alt="Brand Story"
                className="w-full col-start-2 col-end-3"
              />
              <Image
                src={setting}
                alt="Brand Story"
                className="w-full col-start-3 col-end-4"
              />
              <Image
                src={champion}
                alt="Brand Story"

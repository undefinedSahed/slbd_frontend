          ...
          <div className="space-y-5 lg:space-y-10">
            ...
            <div className="space-y-4 lg:space-y-8">
              <div className="bg-primary/10 py-6 px-6 rounded-lg">
                ...
                <div>
                  <a href="tel:+8801777210027" className="text-gray-600">
                    Hotline: +880 1777-210027
                  </a>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div className="rounded-lg w-full border border-primary">
                    <iframe
                      ...
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3649.818930891754!2d90.34981097516602!3d23.825036978619547!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xac7f3a48336e6375%3A0x8170a55898a9b7f2!2sSuper%20Lighting%20BD!5e0!3m2!1sen!2sbd!4v1747686245455!5m2!1sen!2sbd"
                    ></iframe>
                  </div>
                  <p className="text-gray-600 pt-">
                    House: 110, Road: 02, Block: D, Pallabi 2nd Project,
                    Rupnagar, Mirpur
                  </p>
                </div>
              </div>
              ...
              <div className="bg-primary/10 py-6 px-6 rounded-lg space-y-2">
                ...
                <div>
                  <a
                    href="mailto:superlightingbd@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-600"
                  >
                    Contact Email: superlightingbd@gmail.com
                  </a>
                </div>
              </div>
            </div>
